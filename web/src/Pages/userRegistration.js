...
class userRegistration extends Component {
  ...
  handleSubmit = (e) => {
    ...
    if (
      ...
      (this.state.user.type != "Buyer" && this.state.user.type != "Farmer") ||
      ...
      if (this.state.user.type === "Buyer" && this.state.user.address === "")
        ...
        // checking if the password and repeat password matches
        alert("Your passwords doesn't match,please check!");
      else {
        this.props
          .addUser(this.state.user)
          .then((res) => {
            // invoking the addUser action while passing the user object from the state as an argument
              ...
              <div class="form row g-2">
                ...
                <div class="form col-3">
                  ...
                  >
                    ...
                    <option key="1" value="Buyer">
                      Buyer
                    </option>
                    <option key="2" value="Farmer">
                      Farmer
                    </option>
                  </select>
                </div>
