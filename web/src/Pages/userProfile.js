...
// handling the submit action of the form, validating the fields and calling the action to update the User
  handleSubmit = (e) => {
    e.preventDefault();
    if(this.state.userUpdate.firstName === "" || this.state.userUpdate.lastName === "" || this.state.userUpdate.email === "" || (this.state.userUpdate.type != "Buyer" &&  this.state.userUpdate.type != "Farmer") || this.state.userUpdate.phoneNumber === "") //checking if any field is empty
        ...
        return(
          ...
          <div class="col-3">
              ...
              <div class="form col-3">
                  ...
                  <option key="2" value="Farmer" selected={this.props.users.currentUser.type === "Farmer"}>Farmer</option>
                  </select>
              </div>     
              </div>    
