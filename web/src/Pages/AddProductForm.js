...
import { addProduct } from "../actions/farmerActions";
import { updateProduct } from "../actions/farmerActions";
...
function AddProductForm(props) {
  ...
  const handlesubmit = (e) => {
    ...
    props
      .addProduct(state.product, state.file)
      .then((res) => {
        window.location.href = "/farmer";
      })
      .catch((err) => {
  ...
  const handleUpdateProduct = (e) => {
    ...
    props
      .updateProduct(state.product, productWantTOUpdate._id)
      .then((res) => {
...
export default connect(mapStateToProps, { addProduct, updateProduct })(
  AddProductForm
);
